<template>
  <div class="max-w-6xl mx-auto px-4 py-12">
    ...
    <nav data-testid="breadcrumb" aria-label="Navigačná cesta" class="flex items-center gap-2 text-sm text-gray-400 mb-8 flex-wrap">
      ...
      <span>/</span>
      <span class="text-gray-700 font-medium">Anorganická chémia</span>
    </nav>

    <div class="flex items-center gap-3 mb-3">
      <span class="text-4xl">🪨</span>
      <h1 class="text-4xl font-extrabold text-orange-700">Anorganická chémia</h1>
    </div>
    <p class="text-gray-500 text-lg mb-10">
      Prvky a ich anorganické zlúčeniny — kovy, nekovy, voda.
    </p>
...
const sections = [
  {
    slug: 'nekovy',
    icon: '💨',
    title: 'Nekovy a ich zlúčeniny',
    desc: 'Vodík, kyslík, dusík, síra, uhlík, halogény, vzácne plyny a ich zlúčeniny.',
    bg: 'bg-sky-600',
    link: '/chemia/anorganicka-chemia/nekovy',
  },
  {
    slug: 'kovy',
    icon: '🔩',
    title: 'Kovy a ich zlúčeniny',
    desc: 'Alkalické kovy, kovy alkalických zemín, prechodné kovy, zliatiny.',
    bg: 'bg-stone-600',
    link: '/chemia/anorganicka-chemia/kovy',
  },
]

useHead({
  title: 'Anorganická chémia | Chémia | Náuka Portál',
  meta: [
    { name: 'description', content: 'Prvky a ich anorganické zlúčeniny — kovy, nekovy, voda. Kompletná anorganická chémia pre gymnázium.' },
    { property: 'og:title', content: 'Anorganická chémia | Chémia | Náuka Portál' },
    { property: 'og:description', content: 'Prvky a ich anorganické zlúčeniny — kovy, nekovy, voda. Kompletná anorganická chémia pre gymnázium.' },
  ],
})
</script>
