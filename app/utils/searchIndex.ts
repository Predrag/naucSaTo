...
export const searchIndex: SearchEntry[] = [
  ...
  {
    title: 'Chémia',
    description: 'Bezpečnosť v laboratóriu, atómy, chemické reakcie, organická chémia pre gymnazistov.',
    path: '/chemia',
    category: 'Chémia',
    keywords: 'chemia predmet gymnazium laboratorium reakcie atomy chemia strednoskola SŠ',
  },
  {
    title: 'Úvod do chémie',
    description: 'Bezpečnosť, látky, zmesi, roztok, molárna hmotnosť, Avogadrova konštanta.',
    path: '/chemia/uvod',
    category: 'Chémia / Úvod',
    keywords: 'uvod chemia latky zmesi roztok molarna hmotnost avogadro mol zaciatok chemia pre zaciatocnikov',
  },
  {
    title: 'Bezpečnosť v laboratóriu',
    description: 'Laboratórne pomôcky, bezpečnostné pravidlá, prvá pomoc v chemickom laboratóriu.',
    path: '/chemia/uvod/bezpecnost-laboratorium',
    category: 'Chémia / Úvod',
    keywords: 'bezpecnost laboratorium pomucky skumavka kadicky erlenmayerova banka kahan svorka bezpecnostne pravidla chemicke laboratorium prva pomoc poziar korrozivna latka jedovata zapaľlivá ochrana zrak rukavice',
  },
  {
    title: 'Sústavy látok',
    description: 'Látky, zmesi, roztok, molárna hmotnosť, látkové množstvo, Avogadrova konštanta, koncentrácia.',
    path: '/chemia/uvod/sustava-latkov',
    category: 'Chémia / Úvod',
    keywords: 'sustava latok cista latka zmes homogenna heterogenna roztok hmotnostny zlomok molarna hmotnost M mol avogadro 6 022 koncentracia c n V molove hmotnost hmotnost molu molarne mnozstvo M m n',
  },
  {
    title: 'Stavba látky a periodická sústava',
    description: 'Atóm, jadro, elektróny, ióny, PSP, periódy, skupiny, kovy, nekovy.',
    path: '/chemia/stavba-latky',
    category: 'Chémia / Stavba látky',
    keywords: 'stavba latky atom proton neutron elektron periodicka sustava prvkov PSP periody skupiny kovy nekovy ion',
  },
  {
    title: 'Stavba atómu',
    description: 'Protóny, neutróny, elektróny, nukleónové číslo, izotopy, Bohrov model.',
    path: '/chemia/stavba-latky/stavba-atomu',
    category: 'Chémia / Stavba látky',
    keywords: 'stavba atomu proton neutron elektron nukleonove cislo Z A izotopy bohrov model ion kation anion elektronovy obal valencia valencna vrstva jadro naboj atómu protonove cislo neutronove cislo',
  },
  {
    title: 'Periodická sústava prvkov',
    description: 'Periódy, skupiny, kovy, nekovy, polokovy, elektronegativita, alkalické kovy, halogény.',
    path: '/chemia/stavba-latky/periodicka-tabulka',
    category: 'Chémia / Stavba látky',
    keywords: 'periodicka tabulka prvkov PSP periody skupiny kovy nekovy polokovy elektronegativita alkalicke kovy alkalicke zeminy halogeny vzacne plyny periodicky zakon mendelejev ionizacna energia atomovy polomer H He Li Be B C N O F Ne Na Mg Al Si P S Cl Ar K Ca biogenne prvky',
  },
  {
    title: 'Chemická väzba',
    description: 'Kovalentná, iónová, vodíková a kovová väzba. Molekuly, kryštály, medzimolekulové sily.',
    path: '/chemia/stavba-latky/chemicka-vazba',
    category: 'Chémia / Stavba látky',
    keywords: 'chemicka vazba kovalentna nepolarna polarna ionova vodikova kovova molekula krystal H2O NaCl zdielany elektronovy par elektrónový dipol parciálny naboj medzimolekulove sily vodikovy mosticek anomalia vody led plava diamant grafit',
  },
  {
    title: 'Názvoslovie zlúčenín',
    description: 'Oxidačné čísla, názvoslovie oxidov, hydroxidov, kyselín, solí anorganických zlúčenín.',
    path: '/chemia/stavba-latky/nazvoslovie',
    category: 'Chémia / Stavba látky',
    keywords: 'nazvoslovie zlucenin oxidacne cislo oxid SO2 CO2 CaO hydroxid NaOH Ca OH 2 kyselina HCl H2SO4 HNO3 sol NaCl CaCO3 systematicky nazov trivialny nazov amoniak voda siran chlorid dusicnan uhličitan oxidacne cislo kovov anorganicka chemia nazvy',
  },
  {
    title: 'Chemické reakcie',
    description: 'Rovnice, stechiometria, kinetika, rovnováha, redox, acidobáza, pH.',
    path: '/chemia/chemicke-reakcie',
    category: 'Chémia / Chemické reakcie',
    keywords: 'chemicke reakcie rovnice stechiometria redox pH kyseliny zasady katalyzator rovnovaha vycislovanie rovnic',
  },
  {
    title: 'Chemické rovnice a stechiometria',
    description: 'Zápis reakcií, zákon zachovania hmotnosti, stechiometrické koeficienty, typy reakcií.',
    path: '/chemia/chemicke-reakcie/chemicke-rovnice',
    category: 'Chémia / Chemické reakcie',
    keywords: 'chemicke rovnice stechiometria zakon zachovania hmotnosti exotermicka endotermicka reakčné teplo deltaH synteza rozklad substitucia vycislovanie koeficienty reaktanty produkty stechiometricke vypocty n m M molarne pomery',
  },
  {
    title: 'Rýchlosť reakcie a rovnováha',
    description: 'Faktory rýchlosti, katalyzátor, chemická rovnováha, Le Chatelier.',
    path: '/chemia/chemicke-reakcie/rychlost-rovnovaha',
    category: 'Chémia / Chemické reakcie',
    keywords: 'rychlost reakcie katalyzator rovnovaha Le Chatelier koncentracia teplota tlak Haber Bosch amoniak NH3 rovnovazna konstanta K aktivacna energia aktivovaný komplex enzym biochemia',
  },
  {
    title: 'Kyseliny, zásady a pH',
    description: 'Brönstedova teória, pH, neutralizácia, soli, indikátory.',
    path: '/chemia/chemicke-reakcie/acidobaza-pH',
    category: 'Chémia / Chemické reakcie',
    keywords: 'kyseliny zasady pH neutralizacia sol Bronsted indikator lakmus fenolftaleín kyslost zasaditost autoprotolýza vody H+ OH- silna kyselina slaba HCl H2SO4 HNO3 NaOH KOH Ca OH 2 acidobazova reakcia protolytická reakcia ionovy zapis zrazcacia reakcia pH stupnica',
  },
  {
    title: 'Redoxné reakcie',
    description: 'Oxidácia, redukcia, oxidačné čísla, elektrolýza, korózia kovov.',
    path: '/chemia/chemicke-reakcie/redox',
    category: 'Chémia / Chemické reakcie',
    keywords: 'redox oxidacia redukcia oxidacne cisla elektrolýza korozia kovov napatiovy rad elektrochemicky rad oxidovadlo redukovadlo MnO4 dichromat galvanicky clanok elektrolyt anoda katoda',
  },
  {
    title: 'Anorganická chémia',
    description: 'Prvky a ich anorganické zlúčeniny — kovy, nekovy, voda.',
    path: '/chemia/anorganicka-chemia',
    category: 'Chémia / Anorganická chémia',
    keywords: 'anorganicka chemia kovy nekovy voda prvky zluceniny halogenidy oxidy hydroxidy soli',
  },
  {
    title: 'Nekovy a ich zlúčeniny',
    description: 'Vodík, kyslík, dusík, síra, uhlík, halogény, vzácne plyny, voda.',
    path: '/chemia/anorganicka-chemia/nekovy',
    category: 'Chémia / Anorganická chémia',
    keywords: 'nekovy vodik H2 kyslik O2 dusik N2 sira S uhlik C halogeny vzacne plyny amoniak NH3 ozon O3 ozonova diera kyslý dazdˇ SO2 CO2 sklenikovy efekt HCl traskava zmes anomalia vody tvrda maka voda vodni kamen Haber Bosch dusicnany hnojiva',
  },
  {
    title: 'Kovy a ich zlúčeniny',
    description: 'Alkalické kovy, kovy alkalických zemín, prechodné kovy, zliatiny.',
    path: '/chemia/anorganicka-chemia/kovy',
    category: 'Chémia / Anorganická chémia',
    keywords: 'kovy alkalicke Na K Li sodík draslík lítium Ca Mg vápnik horčík prechodne zeleza Fe med Cu zlato Au striebro Ag hlinik Al zliatiny oceľ bronz mosadz plámenoví skúška vápno vápenec CaCO3 CaO Ca OH 2 vysoka pec surovec korozia hrdza oxidacia',
  },
  {
    title: 'Organická chémia',
    description: 'Uhľovodíky, deriváty, polyméry, ropa.',
    path: '/chemia/organicka-chemia',
    category: 'Chémia / Organická chémia',
    keywords: 'organicka chemia uhlovodiky derivaty polymery ropa zemny plyn izomeria C H O N organicke zluceniny',
  },
  {
    title: 'Uhľovodíky',
    description: 'Alkány, alkény, alkíny, arény — názvoslovie, izoméria, reakcie.',
    path: '/chemia/organicka-chemia/uhlovodiky',
    category: 'Chémia / Organická chémia',
    keywords: 'uhlovodiky alkany CnH2n+2 alkeny CnH2n alkiny CnH2n-2 areny benzen metan CH4 etan propan butan izomeria IUPAC nazvoslovie horenie adicna substitucia radikalova polymerizacia etylén acetylen nasytene nenasytene aromaticke',
  },
  {
    title: 'Deriváty uhľovodíkov a polyméry',
    description: 'Deriváty, alkoholy, kyseliny, estery, ropa, zemný plyn, polyméry.',
    path: '/chemia/organicka-chemia/derivaty-a-plasty',
    category: 'Chémia / Organická chémia',
    keywords: 'derivaty uhlovodikov polymery plast ropa benzin destilaciaia PE PP PVC PS PET alkohol etanol metanol OH karbonylova COOH octova kyselina ester esterifikacia aldehyd keton amin polymerizacia makromolekula PE polyetylen polystyren ekologia mikroplasty oktan zemny plyn metan',
  },

  // ── Matematika ────────────────────────────────────────────────────────────
  {
    title: 'Matematika',
    description: 'Prehľad tém matematiky — čísla, funkcie, geometria, kombinatorika, logika.',
    path: '/matematika',
    category: 'Matematika',
    keywords: 'matematika predmet gymnazium algebra geometria funkcie kombinatorika logika mat matura',
  },

  // Sekcie
  { title: 'Čísla, premenné a výrazy', description: 'Číselné obory, mocniny, rovnice, percentá.', path: '/matematika/cisla-a-vyrazy', category: 'Matematika / Čísla a výrazy', keywords: 'cisla vyrazy rovnice percenta mocniny' },
  { title: 'Funkcie a grafy', description: 'Lineárna, kvadratická, exponenciálna, logaritmická a goniometrické funkcie.', path: '/matematika/funkcie', category: 'Matematika / Funkcie', keywords: 'funkcie grafy linearna kvadraticka exponencialna logaritmicka goniometricke' },
  { title: 'Geometria a meranie', description: 'Planimetria, trigonometria, stereometria, analytická geometria.', path: '/matematika/geometria', category: 'Matematika / Geometria', keywords: 'geometria meranie planimetria trigonometria stereometria analyticka geometria' },
  { title: 'Kombinatorika a štatistika', description: 'Kombinatorika, pravdepodobnosť, štatistika, faktoriál.', path: '/matematika/kombinatorika-statistika', category: 'Matematika / Kombinatorika', keywords: 'kombinatorika statistika pravdepodobnost faktorial' },
  { title: 'Logika, dôkazy a postupnosti', description: 'Výroky, dôkazovanie, aritmetická a geometrická postupnosť.', path: '/matematika/logika-a-dokazovanie', category: 'Matematika / Logika', keywords: 'logika dokazy postupnosti vyroky indukcia' },

  // Čísla a výrazy
  {
    title: 'Čísla a množiny',
    description: 'Číselné obory N, Z, Q, R, I; množiny; intervaly; absolútna hodnota.',
    path: '/matematika/cisla-a-vyrazy/cisla-a-mnoziny',
    category: 'Matematika / Čísla a výrazy',
    keywords: 'cisla mnoziny intervaly absolutna hodnota racionalne iracionalne realne prirodzene cele cisla N Z Q R I prienik zjednotenie doplnok venov diagram prvocislo NSD NSN desatinny rozvoj',
  },
  {
    title: 'Mocniny a odmocniny',
    description: 'Pravidlá pre mocniny, odmocniny, vedecký zápis čísla, logaritmy.',
    path: '/matematika/cisla-a-vyrazy/mocniny-odmocniny',
    category: 'Matematika / Čísla a výrazy',
    keywords: 'mocniny odmocniny vedecky zapis logaritmus exponent pravidla mocnin a^n a^r umocnovanie odmocnovanie n-ta odmocnina negatívny exponent zlomkovy exponent',
  },
  {
    title: 'Rovnice a nerovnice',
    description: 'Lineárne a kvadratické rovnice, diskriminant, sústavy rovníc, nerovnice.',
    path: '/matematika/cisla-a-vyrazy/rovnice-a-nerovnice',
    category: 'Matematika / Čísla a výrazy',
    keywords: 'rovnice nerovnice linearne kvadraticke diskriminant D b2-4ac sustava rovnic vietove vztahy x1 x2 koren rovnice ekvivalentna uprava dosadzovacia metoda eliminacia korene parabolou nerovnica riesenie',
  },
  {
    title: 'Percentuálne výpočty',
    description: 'Percentá, promile, trojčlenka, úmernosť, jednoduché a zložené úrokovanie.',
    path: '/matematika/cisla-a-vyrazy/percentualne-vypocty',
    category: 'Matematika / Čísla a výrazy',
    keywords: 'percenta promile trojclenka priama nepriama umernost urok zlozene jednoduche urockovanie zaklad p% zlava navysenie kapital rocna urokova miera hypoteka sporenie',
  },

  // Funkcie a grafy
  {
    title: 'Základy funkcie',
    description: 'Definícia funkcie, definičný obor, obor hodnôt, vlastnosti (rast, párnosť, periodicita).',
    path: '/matematika/funkcie/zaklady-funkcie',
    category: 'Matematika / Funkcie',
    keywords: 'funkcia definicny obor obor hodnot graf rast klesanie parost nepárnosť periodicita nulove body maximum minimum ohranicena monotonnost spojitost inverzia zlozena funkcia predpis',
  },
  {
    title: 'Lineárna a kvadratická funkcia',
    description: 'Lineárna funkcia (smernica), kvadratická (parabola, vrchol, diskriminant).',
    path: '/matematika/funkcie/linearna-kvadraticka',
    category: 'Matematika / Funkcie',
    keywords: 'linearna funkcia y kx q smernica k priamka kvadraticka funkcia y ax2 bx c parabola vrchol V osa symetrie diskriminant D koren kvadraticka nerovnica interaktivny graf slider',
  },
  {
    title: 'Exponenciálna a logaritmická funkcia',
    description: 'Exponenciálna funkcia aˣ, logaritmus, ln, logaritmické vzorce a rovnice.',
    path: '/matematika/funkcie/exponencialna-logaritmicka',
    category: 'Matematika / Funkcie',
    keywords: 'exponencialna funkcia a^x zaklad logaritmicka log_a x inverzia ln prirodzeny logaritmus log10 dekadicky eulerovo cislo e 2 718 logaritmicke vzorce sucin podiel mocnina zmena základu rovnice exponencialne rovnice bancove urocky',
  },
  {
    title: 'Goniometrické funkcie',
    description: 'Jednotková kružnica, sínus, kosínus, tangens, grafy a periodičnosť.',
    path: '/matematika/funkcie/goniometricke-funkcie',
    category: 'Matematika / Funkcie',
    keywords: 'sinus sin cosinus cos tangens tg cotangens cotg goniometricke funkcie jednotkova kruznica perioda 2pi amplituda grafon sin a cos goniometricke rovnice arkussinus arkuskosinus 30 45 60 90 stupnov specialne uhly jednotkova kruznica alpha uhol',
  },

  // Geometria
  {
    title: 'Planimetria',
    description: 'Trojuholník, Pytagorova veta, zhodnosť, podobnosť, kružnica, obvod a obsah útvarov.',
    path: '/matematika/geometria/planimetria',
    category: 'Matematika / Geometria',
    keywords: 'planimetria trojuholnik pytagorova veta a2 b2 c2 zhodnost podobnost kruznica obsah obvod stvorcec obdlznik kosostvorec lichobeznik kruh obluk vysec uhol pravouhy tupouhlý ostrouhly rovnoramenny rovnostranny talésova veta euklidove vety Pytagoras',
  },
  {
    title: 'Trigonometria',
    description: 'Sínusová a kosínusová veta, obsah trojuholníka, Heronov vzorec.',
    path: '/matematika/geometria/trigonometria',
    category: 'Matematika / Geometria',
    keywords: 'trigonometria sinusova veta kosínusova veta obsah trojuholnika heronov vzorec sin alfa cos beta a b c sinus kosinus tangens kotangens pravouhlý trojuholnik vypocet strán uhlov',
  },
  {
    title: 'Stereometria',
    description: 'Kocka, kváder, valec, kužeľ, guľa — povrch a objem, siete telies.',
    path: '/matematika/geometria/stereometria',
    category: 'Matematika / Geometria',
    keywords: 'stereometria kocka kvader valec kuzel gula hranol ihlan povrch objem siete telies V S priestor 3D teleso vzorec povrch gule 4pir2 objem gule 4/3 pi r3 objem valca pi r2 h objem kuzel 1/3',
  },
  {
    title: 'Analytická geometria',
    description: 'Súradnicová sústava, vzdialenosť bodov, rovnica priamky a kružnice.',
    path: '/matematika/geometria/analyticka-geometria',
    category: 'Matematika / Geometria',
    keywords: 'analyticka geometria suradnicova sustava suradnice bod vzdialenost priamka kruznica rovnica priamky ax by c smernicovy tvar y kx q normalovy vektor smerovy vzdialenost bodu od priamky rovnica kruznice stred polomer',
  },

  // Kombinatorika
  {
    title: 'Kombinatorika',
    description: 'Permutácie, variácie, kombinácie, faktoriál, Pascalov trojuholník, binomická veta.',
    path: '/matematika/kombinatorika-statistika/kombinatorika',
    category: 'Matematika / Kombinatorika',
    keywords: 'kombinatorika permutacie variacie kombinácie faktorial n! pascalov trojuholnik binomicka veta n nad k kombinacne cislo pravidlo suctu sucinu Cn Vn Pn usporiadane neusporiadane vyber',
  },
  {
    title: 'Pravdepodobnosť',
    description: 'Klasická definícia pravdepodobnosti, nezávislé javy, Bernoulliho schéma.',
    path: '/matematika/kombinatorika-statistika/pravdepodobnost',
    category: 'Matematika / Kombinatorika',
    keywords: 'pravdepodobnost nahodny jav bernoulli nezavisle udalosti klasicka definicia P A p q doplnkova pravdepodobnost podmienena pravdepodobnost geometricka pravdepodobnost laplace nahodny pokus priaznivy vysledok',
  },
  {
    title: 'Štatistika',
    description: 'Priemer, medián, modus, rozptyl, smerodajná odchýlka, histogram.',
    path: '/matematika/kombinatorika-statistika/statistika',
    category: 'Matematika / Kombinatorika',
    keywords: 'statistika priemer aritmeticky priemer median modus rozptyl smerodajna odchylka histogram absolutna relativna pocetnost triedenie dat variabilita stredna hodnota vazeny priemer normalne rozdelenie',
  },

  // Logika
  {
    title: 'Výroky a logika',
    description: 'Výrok, implikácia, ekvivalencia, logické spojky, kvantifikátory, de Morgan.',
    path: '/matematika/logika-a-dokazovanie/vyroky-a-logika',
    category: 'Matematika / Logika',
    keywords: 'vyroky logika implikacia ekvivalencia konjunkcia disjunkcia negacia kvantifikatory de morgan tautologia kontradikcia existencny vseobecny kvantifikator pravdivostna hodnota logicke spojky zlozenyd vyrok',
  },
  {
    title: 'Dôkazovanie',
    description: 'Priamy dôkaz, dôkaz sporom, protipríklad, matematická indukcia.',
    path: '/matematika/logika-a-dokazovanie/dokazovanie',
    category: 'Matematika / Logika',
    keywords: 'dokazovanie priamy dokaz sporom nepriamy protipriklad matematicka indukcia baza indukcny krok tvrdenie hypoteza axioma definicia veta',
  },
  {
    title: 'Postupnosti a rady',
    description: 'Aritmetická a geometrická postupnosť, vzorce, nekonečný rad, sigma notácia.',
    path: '/matematika/logika-a-dokazovanie/postupnosti',
    category: 'Matematika / Logika',
    keywords: 'postupnosti rady aritmeticka a1 d n-ty clen geometricka kvocient q nekonecny geometricky rad sucet sigma notacia rekurentna postupnost monotonna ohranicena Fibonacciho postupnost',
  },
